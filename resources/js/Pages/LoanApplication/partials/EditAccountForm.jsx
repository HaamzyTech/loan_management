...
const EditAccountForm = ({className,user}) => {
    const { data, setData, patch, errors, processing, recentlySuccessful } =
    useForm({
      account_number: user.loan_account.account_number,
      status: user.loan_account.status,
      user_id: user.id,
    });
    ...
    const submit = (e) => {
      ...
      patch(route('account.update',{id:user.loan_account.id}));
    };
  return (
